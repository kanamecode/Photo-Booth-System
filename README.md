...
- **強固なセキュリティ**  
  ...
  QRコードで写真を渡す際、同じWi-Fiに接続している第三者の端末から傍受されないよう、暗号化することでセキュリティを確保しています。
...
- **非営利目的での使用**に限ります。**<span style="color:red;">本システムは営利目的で使用することはできません。</span>**
...
- **使用においては、以下の制限があります**：
  - 文化祭・その他イベントにおける費用回収は、**印刷用紙代、インク代、装飾費用**等、実際にかかった経費を超えてはいけません。過剰な金額を回収することは禁止されています。

### 4. 禁止事項
- 本システムの商業目的での利用、販売、配布は禁止されています。
- 申請された機関以外の第三者には提供できません。
...
1. **損害について**  
   本システムの使用または使用不能から生じる、いかなる直接的・間接的な損害についても、開発者は一切の責任を負いません。
